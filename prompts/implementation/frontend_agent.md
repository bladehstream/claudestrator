...
2. **Understand test expectations** - What components, behaviors, and interactions are expected
...
│                                                                              │
│   YOU (Frontend Implementation Agent)                                        │
│       └── Read existing tests                                                │
│       └── Implement components to pass those tests                           │
