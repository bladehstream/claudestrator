...
id: mid_game_designer
version: 1.0
category: design
domain: [game]
task_types: [design, planning, documentation]
keywords: [game, design, feature, specification, content, balance, user story, requirements]
complexity: [normal]
pairs_with: [sr_game_designer, game_designer, producer_agent]
source: local
---
