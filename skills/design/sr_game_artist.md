---
name: Senior Game Artist
id: sr_game_artist
version: 1.0
category: design
domain: [game, art]
task_types: [design, asset, documentation]
keywords: [art, style, visual, direction, palette, character, environment, ui, guide, pipeline]
complexity: [normal, complex]
pairs_with: [svg_asset_generator, game_designer, frontend_design]
source: local
---
...
**Mood through Color:**
- **Warm colors** (red, orange, yellow): Energy, urgency, danger
- **Cool colors** (blue, green, purple): Calm, mystery, safety
- **High saturation**: Cartoon, playful, arcade
- **Low saturation**: Realistic, serious, moody
- **High contrast**: Action, visibility, accessibility
- **Low contrast**: Atmosphere, subtlety, realism

**Palette Harmony Types:**
- **Complementary**: High contrast, vibrant (opposite on wheel)
- **Analogous**: Harmonious, calm (adjacent on wheel)
- **Triadic**: Balanced, vibrant (equidistant on wheel)
- **Monochromatic**: Unified, elegant (single hue variations)
